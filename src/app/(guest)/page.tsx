...
export default function Home() {
  return (
    <main className="sm:container">
      ...
      <section className="hidden lg:block pt-16 pb-32">
        <div className="grid grid-cols-3 place-items center">
          ...
          <div className="flex flex-col items-center">
            <div className="flex flex-col bg-blue-500 text-white relative justify-center items-center rounded-full w-12 h-12">
              <p className="text-2xl font-bold
              before:content=[''] before:absolute before:w-[2000px]
              before:-z-10 before:top-1/2 before:h-[2px]
              before:-left-[1080px] before:bg-blue-500
      ...
      <section>
        <div className="pt-16 w-full absolute left-0 bg-map bg-cover bg-no-repeat bg-center bg-blue-600 bg-opacity-25 
        bg-blend-overlay">
